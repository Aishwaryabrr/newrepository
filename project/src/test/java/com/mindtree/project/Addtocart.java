...
public class Addtocart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@id='spree_user_email'])[2]")).sendKeys("aishwarya4718@gmail.com");
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[3]")).click();
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[3]")).sendKeys("aishu@123");
		...
		Thread.sleep(2000);
		driver.findElement(By.id("order_ship_adress_attributes_zipcode")).click();
		driver.findElement(By.id("order_ship_adress_attributes_zipcode")).sendKeys("560057",Keys.TAB);
		...
		driver.findElement(By.id("order_ship_adress_attribues_firstname")).clear();
		driver.findElement(By.id("order_ship_adress_attributes_firstname")).sendKeys("Name",Keys.TAB);
		driver.findElement(By.id("order_ship_adress_attributes_lastname")).sendKeys(Keys.CLEAR,"Lastname",Keys.TAB);
		driver.findElement(By.id("order_ship_adress_attributes_phone")).sendKeys("8835276266");
